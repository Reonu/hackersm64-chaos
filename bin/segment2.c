...
ALIGNED8 const Texture mario_react[] = {
...
ALIGNED8 static const Texture texture_hud_lives[] = {
#include "textures/segment2/custom_lives.rgba16.inc.c"
};
...
const Texture *const main_hud_lut[] = {
    ...
    texture_hud_char_percent,                0x0,                0x0,                0x0,
                   0x0,                0x0,                texture_hud_lives, texture_hud_char_minus,

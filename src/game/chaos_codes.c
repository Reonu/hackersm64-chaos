...
ChaosCode gChaosCodeTable[] = {
    ...
    {"Bouncy Mario", chaos_generic, 100, 15, 30, 0,   /*ignore these*/ 0, 0},
    ...
    {"Mario Gravitation", chaos_generic, 45, 20, 30, 0,  /*ignore these*/ 0, 0},
    {"Hurricane", chaos_generic, 25, 15, 20, 0,  /*ignore these*/ 0, 0},

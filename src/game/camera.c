...
s16 find_in_bounds_yaw_wdw_bob_thi(Vec3f pos, Vec3f origin, s16 yaw) {
    switch (gCurrLevelArea) {
        case AREA_WDW_MAIN:
            ...
            break;
        case AREA_BOB:
            yaw = clamp_positions_and_find_yaw(pos, origin, 16000.f, -16000.f, 16000.f, -16000.f);
            break;
        case AREA_THI_HUGE:
 ...
 */
struct CameraTrigger sCamChaoGarden[] = {
	NULL_TRIGGER
};
struct CameraTrigger sCamTTC[] = {
	NULL_TRIGGER
};
struct CameraTrigger sCamRr2[] = {
	NULL_TRIGGER
};
...
u8 sZoomOutAreaMasks[] = {
	...
	ZOOMOUT_AREA_MASK(1, 1, 0, 0, 1, 0, 0, 0), // SL             | WDW
	...
	ZOOMOUT_AREA_MASK(1, 1, 1, 1, 0, 0, 0, 0), // TTM            | Unused

...
enum GlobalChaosNames {
    ...
    GLOBAL_CHAOS_AMP,
    GLOBAL_CHAOS_COINS_DOWN,
    GLOBAL_CHAOS_RANDOM_SCALE,
    GLOBAL_CHAOS_OBJECTS_FLEE_MARIO,
    GLOBAL_CHAOS_ETHEL_THE_CAT,
    GLOBAL_CHAOS_MARIO_GRAVITATION,
    GLOBAL_CHAOS_HURRICANE,
    GLOBAL_CHAOS_DAB,
    GLOBAL_CHAOS_SWAP_COINS_WITH_MONEYBAGS,
    GLOBAL_CHAOS_SPAWN_KING_BOBOMB,
    GLOBAL_CHAOS_SPAWN_BOWSER,
    GLOBAL_CHAOS_CARPET,
    GLOBAL_CHAOS_ARMSTRONG,
    GLOBAL_CHAOS_INVERTED_FVEL_MAG,
};
...
enum CodeFlags {
    ...
    CODEFLAG_SCREEN,
    CODEFLAG_CAMERA,
    CODEFLAG_AUDIO, // These are also treated as CODEFLAG_MINOR

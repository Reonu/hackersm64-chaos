...
enum CustomMarioAnims {
    MARIO_ANIM_CUSTOM_REKT_BY_KART,
    MARIO_ANIM_CUSTOM_ON_KART_IDLE,
    MARIO_ANIM_CUSTOM_ON_KART_TURN_LEFT,
    MARIO_ANIM_CUSTOM_ON_KART_LEFT_IDLE,
    MARIO_ANIM_CUSTOM_ON_KART_TURN_RIGHT,
    MARIO_ANIM_CUSTOM_ON_KART_RIGHT_IDLE,
    MARIO_ANIM_CUSTOM_GET_COIN,
    MARIO_ANIM_CUSTOM_DAB,
    MARIO_ANIM_FILLER,
    MARIO_ANIM_CUSTOM_POSE_2,
    MARIO_ANIM_CUSTOM_POSE_3,
};

COURSE_ACTS(COURSE_BOB, _(" 1 BOMB OMB BATTLEFIELD"),
       _("BIG BOMB OMB ON THE SUMMIT")     , _("FOOTRACE WITH KOOPA THE QUICK") , _("KOOPA ISLAND"),
       _("8 RED COINS NEAR THE KOOPAS")          , _("FIND THE BABY KOOPA")        , _("BEHIND CHAIN CHOMP'S GATE"))

COURSE_ACTS(COURSE_WF, _(" 2 BETA FORTRESS"),
       _("CHIP OFF WHOMP'S BETA")        , _("TO THE BETA OF THE FORTRESS")    , _("SHOOT INTO THE WILD BETA"),
       _("RED COINS ON THE BETA ISLE"), _("FALL ONTO THE BETA ISLAND")    , _("BLAST AWAY THE BETA"))
...
COURSE_ACTS(COURSE_CCM, _(" 4 HOT, HOT MOUNTAIN"),
...
COURSE_ACTS(COURSE_BBH, _(" 5 HUGE CASTLE COURTYARD"),
       _("SM64DS MOMENT")            , _("8 RED COINS") , _("FLY OVER THE FOUNTAIN"),
       _("IS HE REAL?")          ,  _("MASSACRE IN BATTLE FORT")             , _("ENTER THE CASTLE"))
...
COURSE_ACTS(COURSE_LLL, _(" 7 LETHALER LAVA LAND"),
...
COURSE_ACTS(COURSE_SSL, _(" 8 SHIFTING SNOW LAND"),
       _("IN THE TALONS OF THE BIG BIRD") , _("SHINING ATOP THE PYRAMID")      , _("INSIDE THE ANCIENT PYRAMID"),
       _("STAND TALL ON THE FOUR PILLARS"), _("FREE FLYING FOR 8 RED COINS")   , _("IN THE BACK OF THE PYRAMID"))

COURSE_ACTS(COURSE_DDD, _(" 9 DIRE, DIRE DOCKS"),
       _("BOARD BOWSER'S SUB")            , _("CHESTS IN THE CURRENT")         , _("POLE-JUMPING FOR RED COINS"),
       _("THROUGH THE JET STREAM")        , _("SECRETS OF THE SEAWEED")        , _("COLLECT THE CAPS..."))

COURSE_ACTS(COURSE_SL, _("10 SANDMAN'S LAND"),
       _("SANDMAN'S BIG HEAD")            , _("CHILL WITH THE BULLY")          , _("IN THE DEEP HEAT"),
       _("WHIRL FROM THE BOILING POND")  , _("SHELL SHREDDIN' FOR RED COINS") , _("INTO THE IGLOO"))
...
COURSE_ACTS(COURSE_THI, _("13 ISLAND"),
       _("PLUCK THE PIRANHA FLOWER")      , _("THE TIP TOP OF THE ISLAND"), _("MATCH WITH KOOPA THE AVERAGE"),
       _("FIVE SECRETS")       , _("WIGGLER'S RED COINS")           , _("MAKE WIGGLER SQUIRM"))
...
COURSE_ACTS(COURSE_CHAO_GARDEN, _("15 RAINBOW RIDE"),
       _("CRUISER CROSSING THE RAINBOW")  , _("THE BIG HOUSE IN THE SKY")      , _("COINS AMASSED IN A MAZE"),
       _("SWINGIN' IN THE BREEZE")        , _("TRICKY TRIANGLES!")             , _("SOMEWHERE OVER THE RAINBOW"))

COURSE_ACTS(COURSE_RR2, _("15 RAINBOW RIDE"),
       _("ATOP THE SPIRAL TOWER")  , _("UP AND UP AND UP")      , _("8 RED COINS ACROSS THE RAINBOW"),
       _("SHOOT FAR FAR AWAY")        , _("LMAO THERE'S ONLY 4 STARS")             , _("BRUH"))

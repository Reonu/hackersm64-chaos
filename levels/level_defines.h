...
DEFINE_LEVEL("CHAO_GARDEN", LEVEL_CHAO_GARDEN, COURSE_CHAO_GARDEN, CHAO_GARDEN, generic, 20000, 0x00, 0x00, 0x00, _, sCamChaoGarden) 
DEFINE_LEVEL("RR2", LEVEL_RR2, COURSE_RR2, rr2, generic, 20000, 0x00, 0x00, 0x00, _, sCamRr2) 
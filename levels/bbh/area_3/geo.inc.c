...
const GeoLayout bbh_area_3_geo[] = {
	GEO_NODE_START(),
	GEO_OPEN_NODE(),
		GEO_TRANSLATE_ROTATE_WITH_DL(LAYER_OPAQUE, -223, 39, -7, 90, 0, 0, bbh_dl_Castle_lobby_mesh_layer_1),
		GEO_OPEN_NODE(),
			GEO_DISPLAY_LIST(LAYER_ALPHA, bbh_dl_Castle_lobby_mesh_layer_4),
			GEO_DISPLAY_LIST(LAYER_OPAQUE_DECAL, bbh_dl_Castle_lobby_mesh_layer_2),
		GEO_CLOSE_NODE(),
	GEO_CLOSE_NODE(),
	GEO_RETURN(),
};

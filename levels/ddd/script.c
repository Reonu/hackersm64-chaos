...
const LevelScript level_ddd_entry[] = {
	...
	AREA(1, ddd_area_1),
		...
		OBJECT(MODEL_NONE, -3011, 104, 1600, 0, -8, 0, (2 << 16), bhvCoinFormation),
		OBJECT(MODEL_NONE, -4122, 104, -1614, 0, -8, 0, (2 << 16), bhvCoinFormation),
		OBJECT(MODEL_NONE, -1597, -8195, -89, 0, -8, 0, (2 << 16), bhvCoinFormation),
		OBJECT(MODEL_NONE, -1593, -8195, -1537, 0, -180, 0, 0x00000000, bhvCoinFormation),
		OBJECT(MODEL_NONE, -181, -8149, 1386, 0, 0, 0, 0x00000000, bhvCoinFormation),
		OBJECT(MODEL_NONE, -1737, -6170, 2628, 0, 0, 0, 0x00000000, bhvCoinFormation),
		...
		OBJECT(MODEL_NONE, -2168, -6176, -2271, 0, 0, 0, 0x00000000, bhvSeaweedBundle),
		OBJECT(MODEL_NONE, -2168, -6123, -2271, 0, 0, 0, 0x00000000, bhvHiddenStarTrigger),
		OBJECT(MODEL_NONE, -1024, -6235, 3387, 0, 0, 0, 0x00000000, bhvSeaweedBundle),
		OBJECT(MODEL_NONE, -1024, -6181, 3387, 0, 0, 0, 0x00000000, bhvHiddenStarTrigger),
		OBJECT(MODEL_NONE, -34, -8835, 2443, 0, 0, 0, 0x00000000, bhvSeaweedBundle),
		OBJECT(MODEL_NONE, -34, -8782, 2443, 0, 0, 0, 0x00000000, bhvHiddenStarTrigger),
		OBJECT(MODEL_NONE, -62, -9190, -790, 0, 0, 0, 0x00000000, bhvSeaweedBundle),
		OBJECT(MODEL_NONE, -62, -9137, -790, 0, 0, 0, 0x00000000, bhvHiddenStarTrigger),
		OBJECT(MODEL_NONE, -1682, -8689, -2004, 0, 0, 0, 0x00000000, bhvSeaweedBundle),
		OBJECT(MODEL_NONE, -1682, -8636, -2004, 0, 0, 0, 0x00000000, bhvHiddenStarTrigger),
		OBJECT(MODEL_NONE, 1142, -7208, 3, 0, 0, 0, (4 << 24), bhvHiddenStar),
		...
		OBJECT(MODEL_SUSHI, -1461, -7524, 371, 0, 0, 0, 0x00000000, bhvSushiShark),
		OBJECT(MODEL_SUSHI, -317, -7011, -112, 0, 0, 0, 0x00000000, bhvSushiShark),
		OBJECT(MODEL_SUSHI, -870, -8070, -109, 0, 0, 0, 0x00000000, bhvSushiShark),
		OBJECT(MODEL_SUSHI, -62, -7793, 1405, 0, 0, 0, 0x00000000, bhvSushiShark),

...
void scroll_CHAO_GARDEN_dl_water_visual_mesh_layer_5_vtx_0() {
	int i = 0;
	int count = 30;
	int width = 64 * 0x20;
	int height = 64 * 0x20;
	...
	static int currentY = 0;
	int deltaY;
	Vtx *vertices = segmented_to_virtual(CHAO_GARDEN_dl_water_visual_mesh_layer_5_vtx_0);
...
void scroll_CHAO_GARDEN() {
	...
	scroll_CHAO_GARDEN_dl_water_visual_mesh_layer_5_vtx_0();
};

...
const LevelScript level_wf_entry[] = {
	...
	LOAD_MODEL_FROM_GEO(MODEL_BETA_BREAKABLE_WALL_1, beta_corner_wall_1_geo), 
	LOAD_MODEL_FROM_GEO(MODEL_BETA_BREAKABLE_WALL_2, beta_corner_wall_2_geo), 
	LOAD_MODEL_FROM_GEO(MODEL_THWOMP_BETA, thwomp_beta_geo), 
	...
	AREA(1, wf_area_1),
		...
		OBJECT_WITH_ACTS(MODEL_BOBOMB_BUDDY, -1700, 1140, 3500, 0, 0, 0, 0x00000000, bhvBobombBuddyOpensCannon, ACT_3 | ACT_4 | ACT_5 | ACT_6),
		...
		OBJECT_WITH_ACTS(MODEL_LEVEL_GEOMETRY_09, 1280, 3584, 896, 0, 0, 0, 0x00000000, bhvBulletBillCannon, ACT_2 | ACT_3 | ACT_4 | ACT_5 | ACT_6),
		...
		OBJECT_WITH_ACTS(MODEL_WF_KICKABLE_BOARD, 13, 3584, -1407, 0, -45, 0, 0x00000000, bhvKickableBoard, ACT_2 | ACT_3 | ACT_4 | ACT_5 | ACT_6),
		...
		OBJECT_WITH_ACTS(MODEL_STAR, 300, 5550, 0, 0, 0, 0, 0x01000000, bhvStar, ACT_2 | ACT_3 | ACT_4 | ACT_5 | ACT_6),
		OBJECT(MODEL_STAR, -2500, 1500, -750, 0, 0, 0, 0x02000000, bhvStar),
		OBJECT(MODEL_STAR, 2880, 4300, 190, 0, 0, 0, 0x04000000, bhvStar),
		OBJECT(MODEL_STAR, -1101, 2450, 2650, 0, 0, 0, 0x05000000, bhvStar),
		OBJECT(MODEL_LEVEL_GEOMETRY_07, 1757, 3519, -3151, 0, 0, 0, 0x00000000, bhvStaticObject),
		OBJECT(MODEL_THWOMP_BETA, 3462, 1939, -1545, 0, -180, 0, 0x00000000, bhvThwomp),
		OBJECT(MODEL_THWOMP_BETA, 3462, 1075, -3314, 0, 90, 0, 0x00000000, bhvThwomp2),
		...
		OBJECT(MODEL_BETA_BREAKABLE_WALL_2, -1023, 2176, 2944, 0, 0, 0, 0x00000000, bhvWfBreakableWallLeft),
		OBJECT(MODEL_BETA_BREAKABLE_WALL_1, 512, 2176, 2944, 0, 0, 0, 0x00000000, bhvWfBreakableWallRight),
